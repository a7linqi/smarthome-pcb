...
#endif
uint8_t Seria1_TxPacket[5]={0xAA,0x55,0x01,0x55,0xAA};//无实际用途，测试
...
void Usart3_Init(u32 bound){
	...
	RCC_APB1PeriphClockCmd(RCC_APB1Periph_USART3, ENABLE);	//使能USART3，GPIOB时钟以及复用功能时钟
...
{
	Serial_SendArray(Seria1_TxPacket, 5);
}
